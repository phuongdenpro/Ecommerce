...
export function AdminSidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-64 flex-col border-r admin-border admin-surface admin-text">
      <div className="border-b admin-border p-5">
        <p className="text-lg font-bold">ShopVN Admin</p>
        <p className="mt-1 truncate text-xs admin-muted">{user?.email}</p>
      </div>
